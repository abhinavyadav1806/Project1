                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      ...
                      <?php 
                        ...
                        {
                          echo '<div class="simpleLens-big-image-container"><a data-lens-image="admin/resources/images/'. $row['image'].'" class="simpleLens-lens-image"><img src="admin/resources/images/'. $row['image'].'" class="simpleLens-big-image" ></a></div>';
                          echo '</div>';
                          echo '<div class="simpleLens-thumbnails-container">';
                          echo '<a data-big-image="admin/resources/images/'. $row['image'].'" data-lens-image="admin/resources/images/'. $row['image'].'" class="simpleLens-thumbnail-wrapper" href="#">';
                          echo '<img src="admin/resources/images/'. $row['image'].'" height="55" width="45">';
                           echo '</a>';                                    
                           echo '<a data-big-image="admin/resources/images/'. $row['image'].'" data-lens-image="admin/resources/images/'. $row['image'].'" class="simpleLens-thumbnail-wrapper" href="#">';
                           echo '<img src="admin/resources/images/'. $row['image'].'" height="55" width="45">';
                           echo '</a>';
                          ...
                          echo '<h3>'.$row["name"].'</h3>';
                            ...
                            echo'Category: <a href="#">'.$row["name"].'</a>';
                            echo'</p>';
                            echo'</div>';
                            echo'<div class="aa-prod-view-bottom">';
                              echo'<a class="aa-add-to-cart-btn" href="#">Add To Cart</a>';
